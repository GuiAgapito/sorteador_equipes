...
int main()
{
    ...
    printf("\n\n------- Ola, usuário! Seja bem vindo ao nosso SORTEADOR DE EQUIPES! -------");

    // VariÃ¡vel usada para verificar a escolha do usuÃ¡rio: 1 para sortear e 2 para sair do programa
    int escolha;
    ...
    do
    {
        ...
        printf("\n\nDigite a opção desejada desejada: \n\n1 - Sortear equipes; \n2 - Sair do programa.\n\n");
        scanf("%d", &escolha);
        ...
        // Em um caso onde o usuÃ¡rio digite um numero que na£o esta¡ entre as opcoes, mostra o erro
        default:
            printf("\n---------------------------- TENTE NOVAMENTE! -----------------------------");
            break;
        }
